...
func TestWorkflow_RetryCmd(t *testing.T) {
	c := qt.New(t)
	...
	svc := &mock.WorkflowsService{
		RetryFn: func(ctx context.Context, req *ps.RetryWorkflowRequest) (*ps.Workflow, error) {
...
func TestWorkflow_RetryCmd_Error(t *testing.T) {
	c := qt.New(t)
