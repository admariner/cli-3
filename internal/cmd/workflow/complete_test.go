...
func TestWorkflow_CompleteCmd(t *testing.T) {
	c := qt.New(t)
	...
	svc := &mock.WorkflowsService{
		CompleteFn: func(ctx context.Context, req *ps.CompleteWorkflowRequest) (*ps.Workflow, error) {
...
func TestWorkflow_CompleteCmd_Error(t *testing.T) {
	c := qt.New(t)
